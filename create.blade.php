...
<html>
   ...
   <main>
      ...
      <div class="row justify-content-center">
         <div class="col-lg-6">
            <div class="main">
               <h3><a>Laravel 5.8 Review Rating System.</a></h3>
               <form role="form" action="{{route('post.store')}}" method="post">
                  ...
                  <div class="form-group">
                     <label for="author">Product Author<span class="text-danger">*</span></label>
                     <input type="text" name="author" class="form-control" required>
                  </div>
                  <div class="form-group">
                     <label for="description">Product Description<span class="text-danger">*</span></label>
                     <input type="text" name="prod_description" class="form-control" required>
                  </div>
                  <div class="form-group">
